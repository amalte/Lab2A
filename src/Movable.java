...
public abstract class Movable implements IMovable {
    ...
    /**
     * Moves the object depending on the direction it's facing. Inherits from Interfaces.IMovable interface
     */
    @Override
    public void move() {
    ...
    /**
     * Turns the object to the left depending on it's current direction. Inherits from Movable interface
     */
    @Override
    ...
    /**
     * Turns the object to the right depending on it's current direction. Inherits from Movable interface
     */
    @Override
